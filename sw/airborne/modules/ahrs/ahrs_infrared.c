...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_IR_SENSORS, send_infrared);
  register_periodic_telemetry(DefaultPeriodic, MESG_STATE_FILTER_STATUS, send_status);
#endif
}
