...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_BARO_RAW, send_baro_raw);
  register_periodic_telemetry(DefaultPeriodic, MESG_AIR_DATA, send_air_data);
  register_periodic_telemetry(DefaultPeriodic, MESG_AMSL, send_amsl);
#endif
}
