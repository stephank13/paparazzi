...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_GPS, send_gps);
  register_periodic_telemetry(DefaultPeriodic, MESG_GPS_INT, send_gps_int);
  register_periodic_telemetry(DefaultPeriodic, MESG_GPS_LLA, send_gps_lla);
  register_periodic_telemetry(DefaultPeriodic, MESG_GPS_SOL, send_gps_sol);
  register_periodic_telemetry(DefaultPeriodic, MESG_SVINFO, send_svinfo);
#endif
}
