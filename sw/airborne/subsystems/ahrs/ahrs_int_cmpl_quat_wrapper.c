...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_AHRS_QUAT_INT, send_quat);
  register_periodic_telemetry(DefaultPeriodic, MESG_AHRS_EULER_INT, send_euler);
  register_periodic_telemetry(DefaultPeriodic, MESG_AHRS_GYRO_BIAS_INT, send_bias);
