...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_ACCEL, send_accel);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_GYRO, send_gyro);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_ACCEL_RAW, send_accel_raw);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_ACCEL_SCALED, send_accel_scaled);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_ACCEL, send_accel);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_GYRO_RAW, send_gyro_raw);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_GYRO_SCALED, send_gyro_scaled);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_GYRO, send_gyro);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_MAG_RAW, send_mag_raw);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_MAG_SCALED, send_mag_scaled);
  register_periodic_telemetry(DefaultPeriodic, MESG_IMU_MAG, send_mag);
#endif // DOWNLINK
