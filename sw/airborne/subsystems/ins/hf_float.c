...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_HFF, send_hff);
  register_periodic_telemetry(DefaultPeriodic, MESG_HFF_DBG, send_hff_debug);
#ifdef GPS_LAG
  register_periodic_telemetry(DefaultPeriodic, MESG_HFF_GPS, send_hff_gps);
#endif
#endif
