...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_NAVIGATION_REF, send_nav_ref);
  register_periodic_telemetry(DefaultPeriodic, MESG_NAVIGATION, send_nav);
  register_periodic_telemetry(DefaultPeriodic, MESG_WP_MOVED, send_wp_moved);
  register_periodic_telemetry(DefaultPeriodic, MESG_CIRCLE, send_circle);
  register_periodic_telemetry(DefaultPeriodic, MESG_SEGMENT, send_segment);
  register_periodic_telemetry(DefaultPeriodic, MESG_SURVEY, send_survey);
#endif
}
