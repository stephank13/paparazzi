...
void autopilot_init(void)
{
  ...
  register_periodic_telemetry(DefaultPeriodic, MESG_AUTOPILOT_VERSION, send_autopilot_version);
  register_periodic_telemetry(DefaultPeriodic, MESG_ALIVE, send_alive);
  register_periodic_telemetry(DefaultPeriodic, MESG_PPRZ_MODE, send_mode);
  register_periodic_telemetry(DefaultPeriodic, MESG_ATTITUDE, send_attitude);
  register_periodic_telemetry(DefaultPeriodic, MESG_ESTIMATOR, send_estimator);
  register_periodic_telemetry(DefaultPeriodic, MESG_AIRSPEED, send_airspeed);
  register_periodic_telemetry(DefaultPeriodic, MESG_BAT, send_bat);
  register_periodic_telemetry(DefaultPeriodic, MESG_ENERGY, send_energy);
  register_periodic_telemetry(DefaultPeriodic, MESG_DL_VALUE, send_dl_value);
  register_periodic_telemetry(DefaultPeriodic, MESG_DESIRED, send_desired);
#if defined RADIO_CALIB && defined RADIO_CONTROL_SETTINGS
  register_periodic_telemetry(DefaultPeriodic, MESG_RC_SETTINGS, send_rc_settings);
#endif
#endif
}
