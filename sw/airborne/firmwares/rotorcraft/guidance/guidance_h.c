...
#if PERIODIC_TELEMETRY
  register_periodic_telemetry(DefaultPeriodic, MESG_GUIDANCE_H_INT, send_gh);
  register_periodic_telemetry(DefaultPeriodic, MESG_HOVER_LOOP, send_hover_loop);
  register_periodic_telemetry(DefaultPeriodic, MESG_GUIDANCE_H_REF, send_href);
  register_periodic_telemetry(DefaultPeriodic, MESG_ROTORCRAFT_TUNE_HOVER, send_tune_hover);
#endif
}
