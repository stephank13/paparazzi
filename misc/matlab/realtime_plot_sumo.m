...
figure
subplot 231, xlim('auto'), ylim('auto'), ylabel 'z [m]', xlabel 'T [degC]', hold on
subplot 232, xlim('auto'), ylim('auto'), ylabel 'z [m]', xlabel 'potT [degC]', hold on
subplot 233, xlim('auto'), ylim('auto'), ylabel 'z [m]', xlabel 'RH [perc]', hold on
